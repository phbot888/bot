		...
		try {
			...
			mess = {
				...
				only: {
					...
					ownerB: '❌ Este comando só pode ser usado pelo proprietário do bot ph gasoso ! ❌',
					admin: '⚠️ Este comando só pode ser usado pelo o adm então vire um! 😝',
			...
			switch(command) {
				...
				case 'info':
					...
					break
				case 'blocklist':
					teks = 'Esta é a lista de chatos bloqueados :\n'
				...
				case 'ts':
					...
					if (isMedia && !mek.message.videoMessage || isQuotedImage) {
						...
						for (let _ of anu) {
							sendMess(_.jid, `[ TRANSMISSÃO DO PH]\n\n${body.slice(4)}`)
						}
						reply('Transmissão enviada com sucesso')
					}
					break
